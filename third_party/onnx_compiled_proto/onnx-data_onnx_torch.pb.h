...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_onnx_2fonnx_2ddata_5fonnx_5ftorch_2eproto
...
struct TableStruct_onnx_2fonnx_2ddata_5fonnx_5ftorch_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_onnx_2fonnx_2ddata_5fonnx_5ftorch_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::onnx_torch::MapProto* Arena::CreateMaybeMessage<::onnx_torch::MapProto>(Arena*);
template<> ::onnx_torch::OptionalProto* Arena::CreateMaybeMessage<::onnx_torch::OptionalProto>(Arena*);
template<> ::onnx_torch::SequenceProto* Arena::CreateMaybeMessage<::onnx_torch::SequenceProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace onnx_torch {
...
class SequenceProto PROTOBUF_FINAL :
...
class OptionalProto PROTOBUF_FINAL :
